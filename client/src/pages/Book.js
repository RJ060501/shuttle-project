...
const Book = props => {
  const selectorBody = useMemo(() => {
    return props.trails?.map(planet => 
  ...
  return <Appear id="book" animate show={props.entered}>
    ...
    <form onSubmit={props.submitBooking} style={{display: "inline-grid", gridTemplateColumns: "auto auto", gridGap: "10px 20px"}}>
